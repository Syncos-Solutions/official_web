        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center gap-2 font-medium text-lg">
              <span className="bg-gradient-to-r text-foreground font-mono text-xl text-black bg-clip-textt font-bold">
                Syncos Solutions
              </span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/contact/#Locations" className="text-muted-foreground hover:text-primary transition-colors">
                  Our Locations
                </Link>
              </li>
            </ul>
